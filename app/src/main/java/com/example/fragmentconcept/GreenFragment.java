...
public class GreenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View mView =  inflater.inflate(R.layout.fragment_green, container, false);
        setTile = mView.findViewById(R.id.setTitle);
        setBtn = mView.findViewById(R.id.setBtn);

        setBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                setTile.setText("Welcome To GreenFragment");
            }
        });
        return  mView;
    }
