...
public class RedFragment extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onSetTitle("RED Fragment");
        }
    }

    @Override
    public void onAttach(Context context) { // when fragment is attached to the activity then this method called
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onSetTitle(String title); // we rename the method And its parameter type
    }
}
